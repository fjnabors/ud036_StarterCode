...
lotr2 = movie.Movie("Lord of the Rings: The Two Towers",
...
lotr3 = movie.Movie("Lord of the Rings: The Return of the King",
...
the_dark_knight = movie.Movie("The Dark Knight",
                        "Bruce Wayne/Batman (Bale), James Gordon (Oldman) and Harvey Dent (Eckhart) form an alliance to dismantle organized crime in Gotham City, but are menaced by a criminal mastermind known as the Joker (Ledger) who seeks to undermine Batman's influence and create chaos.",
