...
lotr2 = movie.Movie(
    ...
    "the shifty Gollum, the divided fellowship makes a stand"
...
interstellar = movie.Movie("Interstellar",
    ...
    "space travel and conquer the vast distances involved in an "
    "interstellar voyage.",
...
the_dark_knight = movie.Movie(
    ...
    "menaced by a criminal mastermind known as the Joker (Ledger) who seeks "
    "to undermine Batman's influence and create chaos.",
